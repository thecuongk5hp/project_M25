    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light w-100" style={{ position: 'fixed', top: 0, zIndex: 1000 }}>
      <div className="container-fluid">
        ...
        <a className="navbar-brand" href="#">
          <img src="https://mdbootstrap.com/img/logo/mdb-transaprent-noshadows.webp" height="30" alt="Logo" loading="lazy" />
        </a>

        <div className="collapse navbar-collapse" id="navbarNav">
          <div className="navbar-nav d-flex align-items-center me-auto">
          ...
          <ul className="navbar-nav d-flex flex-row align-items-center">
            ...
            <li className="nav-item dropdown me-3 me-lg-0">
              <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="https://mdbootstrap.com/img/Photos/Avatars/img (31).jpg" className="rounded-circle" height="22" alt="Profile" loading="lazy" />
              </a>
